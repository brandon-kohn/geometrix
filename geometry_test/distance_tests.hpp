...
#include "../geometry/point_distance.hpp"
#include <iostream>
...
BOOST_AUTO_TEST_CASE( TestDistance )
{
    ...
    {	    
        ...
        double d1 = distance_to_point( p1, p2 );
        double d2 = distance_to_point( p1, p3 );
        double d3 = distance_to_point( p2, p3 );
...

    {
        ...
        BOOST_CHECK( distance_to_point( p1, p2 ) == 1 );
        BOOST_CHECK( distance_to_point( p1, p3 ) == 3 );
        BOOST_CHECK( distance_to_point( p2, p3 ) == 1 );   
    }
