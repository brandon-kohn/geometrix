...
//, boost::addable2< reference_frame_tag< CoordinateSequence, ReferenceFrame >       // point + vector
//, boost::subtractable2_left< reference_frame_tag< CoordinateSequence, ReferenceFrame >  // point - vector
//  > >
{
...
//     {
//         indexed_sequence_traversal::for_each( static_cast<CoordinateSequence&>(*this), p, _1 += _2 );
//         return *this;
//     }
