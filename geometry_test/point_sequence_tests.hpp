...
void time_point_containment(const Polygon& poly, std::string name)
{
	...
	typedef node_bsp_tree_2d< segment2 > bsp_tree2;
	...
	vector2 x{ std::get<e_xmax>(bounds_poly), 0 };
	vector2 y{ 0, std::get<e_ymax>(bounds_poly) };
	std::vector<point2> points;
	point2 pmin{ std::get<e_xmin>(bounds_poly), std::get<e_ymin>(bounds_poly) };
...
BOOST_FIXTURE_TEST_CASE(polyline_offset_tests_bug, geometry_kernel_2d_fixture)
{
	using namespace geometrix;
	auto center = polyline2{ { 3.0298016157466918, 75.638376189395785 }, { 2.6571538336575031, 79.483831466175616 }, { 2.485705406521447, 81.52953180950135 }, { 1.8526018894044682, 86.493510996922851 }, { 1.2429139936575666, 93.021163836121559 }, { 0.91037156968377531, 96.64441258367151 }, { 0.41002960607875139, 101.53283658064902 }, { -0.35815154027659446, 110.54771357867867 }, { -0.58751444099470973, 113.04154316522181 }, { -1.9014257467351854, 127.6554881259799 }, { -2.1660090705845505, 130.74875783361495 }, { -2.2077550910180435, 131.39499052520841 }, { -2.6122342082671821, 135.14103845320642 }, { -2.6599264645483345, 136.36601031571627 }, { -2.8068208628101274, 137.94145795051008 }, { -3.3084263472119346, 143.32054897025228 }, { -3.5539036404807121, 146.09106440283358 }, { -3.9776777049992234, 150.80161341093481 }, { -4.1299721335526556, 152.41981271468103 }, { -4.8084987248294055, 159.77125336136669 }, { -5.0294178077019751, 162.37963183410466 }, { -5.1461624504299834, 163.82820164039731 }, { -5.5500382124446332, 167.56135576963425 }, { -5.6143696731887758, 168.63830402866006 }, { -7.9928556510712951, 192.64755479618907 }, { -8.0278607360087335, 194.1536120865494 }, { -8.4045018584001809, 197.31827347166836 }, { -8.6145491055212915, 199.3066682703793 }, { -9.2182260617846623, 204.90112357214093 }, { -9.8750640919897705, 211.21826710179448 }, { -10.19144834834151, 214.70012091565877 }, { -11.158666647272184, 225.05592510197312 }, { -11.476416718098335, 228.27462014835328 }, { -12.639925578143448, 238.28599696047604 }, { -12.861670730519108, 240.08419059310108 } };
	double    offset = 4.5;
	polyline2 left = polyline_offset(center, oriented_left, offset, cmp);
	BOOST_TEST_MESSAGE("left: " << left);
...
#include <geometrix/algorithm/point_sequence/polyline_split.hpp>

BOOST_FIXTURE_TEST_CASE(polyline_point_at_position_midpoint_test, geometry_kernel_2d_fixture)
{
	using namespace geometrix;
	auto pline = polyline2{ { 1098.47527107,1178.48809441 },{ 1071.39171392,1185.84823745 },{ 1059.99795823,1189.00357638 },{ 1049.91310331,1191.87260701 },{ 1041.04481327,1194.50296442 },{ 1033.30075223,1196.94228366 },{ 1026.58858431,1199.2381998 },{ 1020.81597365,1201.43834793 },{ 1015.89058435,1203.59036309 },{ 1011.72008055,1205.74188038 },{ 1008.21212637,1207.94053484 },{ 1005.27438592,1210.23396156 },{ 1002.81452334,1212.6697956 },{ 1000.74020273,1215.29567203 },{ 998.959088237,1218.15922592 },{ 997.378843969,1221.30809234 },{ 995.907134052,1224.78990635 },{ 994.451622609,1228.65230303 },{ 992.919973761,1232.94291745 },{ 993.292221797,1237.59252211 },{ 993.702560876,1241.76720346 },{ 994.228998352,1245.50790274 },{ 994.94954158,1248.85556122 },{ 995.942197916,1251.85112014 },{ 997.284974713,1254.53552075 },{ 999.055879328,1256.94970431 },{ 1001.33291911,1259.13461207 },{ 1004.19410143,1261.13118529 },{ 1007.71743362,1262.98036521 },{ 1011.98092305,1264.72309309 },{ 1017.06257707,1266.40031019 },{ 1023.04040304,1268.05295775 },{ 1029.99240831,1269.72197703 },{ 1037.99660023,1271.44830928 },{ 1047.13098617,1273.27289576 },{ 1057.47357347,1275.23667771 },{ 1082.09538158,1279.74559306 } };
	...
	auto length = polyline_length(pline);
	std::size_t index;
	boost::optional<point2> oPoint;
	std::tie(index, oPoint) = polyline_point_at_position(pline, length * 0.5);
...
BOOST_FIXTURE_TEST_CASE(polyline_point_at_position_front_test, geometry_kernel_2d_fixture)
{
	using namespace geometrix;
	auto pline = polyline2{ { 1098.47527107,1178.48809441 },{ 1071.39171392,1185.84823745 },{ 1059.99795823,1189.00357638 },{ 1049.91310331,1191.87260701 },{ 1041.04481327,1194.50296442 },{ 1033.30075223,1196.94228366 },{ 1026.58858431,1199.2381998 },{ 1020.81597365,1201.43834793 },{ 1015.89058435,1203.59036309 },{ 1011.72008055,1205.74188038 },{ 1008.21212637,1207.94053484 },{ 1005.27438592,1210.23396156 },{ 1002.81452334,1212.6697956 },{ 1000.74020273,1215.29567203 },{ 998.959088237,1218.15922592 },{ 997.378843969,1221.30809234 },{ 995.907134052,1224.78990635 },{ 994.451622609,1228.65230303 },{ 992.919973761,1232.94291745 },{ 993.292221797,1237.59252211 },{ 993.702560876,1241.76720346 },{ 994.228998352,1245.50790274 },{ 994.94954158,1248.85556122 },{ 995.942197916,1251.85112014 },{ 997.284974713,1254.53552075 },{ 999.055879328,1256.94970431 },{ 1001.33291911,1259.13461207 },{ 1004.19410143,1261.13118529 },{ 1007.71743362,1262.98036521 },{ 1011.98092305,1264.72309309 },{ 1017.06257707,1266.40031019 },{ 1023.04040304,1268.05295775 },{ 1029.99240831,1269.72197703 },{ 1037.99660023,1271.44830928 },{ 1047.13098617,1273.27289576 },{ 1057.47357347,1275.23667771 },{ 1082.09538158,1279.74559306 } };
	...
	std::size_t index;
	boost::optional<point2> oPoint;
	std::tie(index, oPoint) = polyline_point_at_position(pline, 0.0);

	BOOST_CHECK(index == 0);
	BOOST_CHECK(!oPoint.is_initialized());
}

BOOST_FIXTURE_TEST_CASE(polyline_point_at_position_back_test, geometry_kernel_2d_fixture)
{
	using namespace geometrix;
	auto pline = polyline2{ { 1098.47527107,1178.48809441 },{ 1071.39171392,1185.84823745 },{ 1059.99795823,1189.00357638 },{ 1049.91310331,1191.87260701 },{ 1041.04481327,1194.50296442 },{ 1033.30075223,1196.94228366 },{ 1026.58858431,1199.2381998 },{ 1020.81597365,1201.43834793 },{ 1015.89058435,1203.59036309 },{ 1011.72008055,1205.74188038 },{ 1008.21212637,1207.94053484 },{ 1005.27438592,1210.23396156 },{ 1002.81452334,1212.6697956 },{ 1000.74020273,1215.29567203 },{ 998.959088237,1218.15922592 },{ 997.378843969,1221.30809234 },{ 995.907134052,1224.78990635 },{ 994.451622609,1228.65230303 },{ 992.919973761,1232.94291745 },{ 993.292221797,1237.59252211 },{ 993.702560876,1241.76720346 },{ 994.228998352,1245.50790274 },{ 994.94954158,1248.85556122 },{ 995.942197916,1251.85112014 },{ 997.284974713,1254.53552075 },{ 999.055879328,1256.94970431 },{ 1001.33291911,1259.13461207 },{ 1004.19410143,1261.13118529 },{ 1007.71743362,1262.98036521 },{ 1011.98092305,1264.72309309 },{ 1017.06257707,1266.40031019 },{ 1023.04040304,1268.05295775 },{ 1029.99240831,1269.72197703 },{ 1037.99660023,1271.44830928 },{ 1047.13098617,1273.27289576 },{ 1057.47357347,1275.23667771 },{ 1082.09538158,1279.74559306 } };
	...
	std::size_t index;
	boost::optional<point2> oPoint;
	std::tie(index, oPoint) = polyline_point_at_position(pline, length);

	BOOST_CHECK(index == pline.size() - 2);
	BOOST_CHECK(!oPoint.is_initialized());
	//auto cmp = absolute_tolerance_comparison_policy<double>( 1e-10 );
	//BOOST_CHECK(numeric_sequence_equals_2d(*oPoint, pline[0], cmp));
}

BOOST_FIXTURE_TEST_CASE(polyline_point_at_position_offset_from_back_test, geometry_kernel_2d_fixture)
{
	using namespace geometrix;
	auto pline = polyline2{ { 1098.47527107,1178.48809441 },{ 1071.39171392,1185.84823745 },{ 1059.99795823,1189.00357638 },{ 1049.91310331,1191.87260701 },{ 1041.04481327,1194.50296442 },{ 1033.30075223,1196.94228366 },{ 1026.58858431,1199.2381998 },{ 1020.81597365,1201.43834793 },{ 1015.89058435,1203.59036309 },{ 1011.72008055,1205.74188038 },{ 1008.21212637,1207.94053484 },{ 1005.27438592,1210.23396156 },{ 1002.81452334,1212.6697956 },{ 1000.74020273,1215.29567203 },{ 998.959088237,1218.15922592 },{ 997.378843969,1221.30809234 },{ 995.907134052,1224.78990635 },{ 994.451622609,1228.65230303 },{ 992.919973761,1232.94291745 },{ 993.292221797,1237.59252211 },{ 993.702560876,1241.76720346 },{ 994.228998352,1245.50790274 },{ 994.94954158,1248.85556122 },{ 995.942197916,1251.85112014 },{ 997.284974713,1254.53552075 },{ 999.055879328,1256.94970431 },{ 1001.33291911,1259.13461207 },{ 1004.19410143,1261.13118529 },{ 1007.71743362,1262.98036521 },{ 1011.98092305,1264.72309309 },{ 1017.06257707,1266.40031019 },{ 1023.04040304,1268.05295775 },{ 1029.99240831,1269.72197703 },{ 1037.99660023,1271.44830928 },{ 1047.13098617,1273.27289576 },{ 1057.47357347,1275.23667771 },{ 1082.09538158,1279.74559306 } };
	...
	std::size_t index;
	boost::optional<point2> oPoint;
	std::tie(index, oPoint) = polyline_point_at_position(pline, length - 1e-6);
...
BOOST_FIXTURE_TEST_CASE(polyline_split_test_on_vertex, geometry_kernel_2d_fixture)
{
	using namespace geometrix;
	auto pline = polyline2{ { 1098.47527107,1178.48809441 },{ 1071.39171392,1185.84823745 },{ 1059.99795823,1189.00357638 },{ 1049.91310331,1191.87260701 },{ 1041.04481327,1194.50296442 },{ 1033.30075223,1196.94228366 },{ 1026.58858431,1199.2381998 },{ 1020.81597365,1201.43834793 },{ 1015.89058435,1203.59036309 },{ 1011.72008055,1205.74188038 },{ 1008.21212637,1207.94053484 },{ 1005.27438592,1210.23396156 },{ 1002.81452334,1212.6697956 },{ 1000.74020273,1215.29567203 },{ 998.959088237,1218.15922592 },{ 997.378843969,1221.30809234 },{ 995.907134052,1224.78990635 },{ 994.451622609,1228.65230303 },{ 992.919973761,1232.94291745 },{ 993.292221797,1237.59252211 },{ 993.702560876,1241.76720346 },{ 994.228998352,1245.50790274 },{ 994.94954158,1248.85556122 },{ 995.942197916,1251.85112014 },{ 997.284974713,1254.53552075 },{ 999.055879328,1256.94970431 },{ 1001.33291911,1259.13461207 },{ 1004.19410143,1261.13118529 },{ 1007.71743362,1262.98036521 },{ 1011.98092305,1264.72309309 },{ 1017.06257707,1266.40031019 },{ 1023.04040304,1268.05295775 },{ 1029.99240831,1269.72197703 },{ 1037.99660023,1271.44830928 },{ 1047.13098617,1273.27289576 },{ 1057.47357347,1275.23667771 },{ 1082.09538158,1279.74559306 } };

	auto d = point_point_distance(pline[0], pline[1]);
	auto length = polyline_length(pline);
	polyline2 a, b;
