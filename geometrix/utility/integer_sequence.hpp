//
//! Copyright © 2017
//! Jappa on GitHub: https://gist.github.com/jappa/62f30b6da5adea60bad3
//! Brandon Kohn
//
...
//
#ifndef GEOMETRIX_INDEX_SEQUENCE_HPP
#define GEOMETRIX_INDEX_SEQUENCE_HPP
#pragma once
...
namespace geometrix {
    ...
    struct integer_sequence
    {
        ...
        static inline std::size_t size() { return (sizeof...(N)); }
    };
...
#endif//! GEOMETRIX_INDEX_SEQUENCE_HPP
