...
BOOST_AUTO_TEST_CASE( TestIndexedSequence )
{
    ...
    //! compile-time access.
    {
	    ...
	    //! Check scalar multiplication
	    {
		    point_tuple_3 c = a;
            indexed_sequence_traversal::for_each( c, _1 *= 4.0 );
            BOOST_CHECK_CLOSE( cartesian_access_traits<point_tuple_3>::get<0>( c ), 4., 1e-10 );
            BOOST_CHECK_CLOSE( cartesian_access_traits<point_tuple_3>::get<1>( c ), 8., 1e-10 );
	    }
	    ...
	    //! Check scalar division
	    {
		    point_tuple_3 c = a;
            indexed_sequence_traversal::for_each( c, _1 /= 4.0 );
            BOOST_CHECK_CLOSE( cartesian_access_traits<point_tuple_3>::get<0>( c ), .25, 1e-10 );
            BOOST_CHECK_CLOSE( cartesian_access_traits<point_tuple_3>::get<1>( c ), .5, 1e-10 );
	    }
