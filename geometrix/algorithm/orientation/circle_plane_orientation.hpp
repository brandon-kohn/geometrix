...
#include <geometric/primitive/sphere.hpp>
...
namespace geometrix {
    ...
    template <typename Point, typename Length, typename Plane, typename NumberComparisonPolicy>
    ...
    template <typename Sphere, typename Plane, typename NumberComparisonPolicy>
    inline orientation_type circle_plane_orientation(const Sphere& s, const Plane& pl, const NumberComparisonPolicy& cmp)
    {
        BOOST_CONCEPT_ASSERT((SphereConcept<Point>));
