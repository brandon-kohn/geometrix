...
public:
	...
	const length_type& get_u_half_width() const { return m_uHalfWidth; }
	const length_type& get_v_half_width() const { return m_vHalfWidth; }
...
private:
	...
	vector_type m_u;
    vector_type m_v;
	length_type m_uHalfWidth;//! The distance from center to border along u.
	length_type m_vHalfWidth;//! The distance from center to border along v.
