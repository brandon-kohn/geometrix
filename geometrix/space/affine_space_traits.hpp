...
//
#ifndef GEOMETRIX_AFFINE_SPACE_TRAITS_HPP
#define GEOMETRIX_AFFINE_SPACE_TRAITS_HPP
...
namespace geometrix {  
    ...
    template < typename AffineSpace, typename EnableIf=void >
    ...
    //! A type models an AffineSpaceConcept if it defines a dimension type.
...
#endif //GEOMETRIX_AFFINE_SPACE_TRAITS_HPP
